...
% optimization
[A,b,Aeq,beq] = create_constraint_matrices(GSV,E,VC,coms,force,sC,sT,sB,'bending',0);

[x,ar,ax,be] = optimize_lp(lengths,A,b,Aeq,beq,'linprog','bending',0);
...
%%
save('bunny-example.mat','AV','AF','ACV','ACF',...
...
% plot other vertices
scatter3(GSV(:,1),GSV(:,2),GSV(:,3),'.k','SizeData',100);
